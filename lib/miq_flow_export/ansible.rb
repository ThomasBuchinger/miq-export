...
begin
  ...
  re = send(settings[:action].to_sym, settings)
  ...
  msg = 'Invalid action. Must be: clone, prep, merge or remove'
  puts generate_ansible_output(changed: false, msg: msg, failed: true)
end
